...
```text
to-java.xsl              76895  36.86%
classes.xsl              61098  29.29%
set-locators.xsl         18710  8.97%
set-original-names.xsl   12534  6.01%
attrs.xsl                10156  4.87%
data.xsl                 9242   4.43%
anonymous-to-nested.xsl  6913   3.31%
tests.xsl                6781   3.25%
package.xsl              6262   3.00%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-01-28 at 06:40,
on Linux with 4 CPUs.
The total is 208591 milliseconds.
...
[benchmark-gha]: https://github.com/tihiyn/eo/actions/runs/21427709636
