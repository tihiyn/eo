...
```text
to-java.xsl              75001  37.67%
classes.xsl              54865  27.55%
set-locators.xsl         17850  8.96%
set-original-names.xsl   11578  5.81%
attrs.xsl                10467  5.26%
data.xsl                 9568   4.81%
tests.xsl                6877   3.45%
anonymous-to-nested.xsl  6477   3.25%
package.xsl              6440   3.23%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-01-15 at 14:42,
on Linux with 4 CPUs.
The total is 199123 milliseconds.
...
[benchmark-gha]: https://github.com/tihiyn/eo/actions/runs/21034889777
