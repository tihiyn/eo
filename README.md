...
```text
to-java.xsl              75463  41.21%
classes.xsl              57274  31.28%
set-locators.xsl         14623  7.99%
set-original-names.xsl   8509   4.65%
attrs.xsl                6835   3.73%
data.xsl                 6507   3.55%
anonymous-to-nested.xsl  4707   2.57%
tests.xsl                4606   2.52%
package.xsl              4588   2.51%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-08-10 at 10:27,
on Linux with 4 CPUs.
The total is 183112 milliseconds.
...
[benchmark-gha]: https://github.com/tihiyn/eo/actions/runs/16860248081
