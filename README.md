...
```text
to-java.xsl              92283  37.29%
classes.xsl              84411  34.11%
set-locators.xsl         19622  7.93%
set-original-names.xsl   13173  5.32%
attrs.xsl                9542   3.86%
data.xsl                 9013   3.64%
package.xsl              6657   2.69%
tests.xsl                6475   2.62%
anonymous-to-nested.xsl  6320   2.55%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-10-03 at 05:56,
on Linux with 4 CPUs.
The total is 247496 milliseconds.
...
[benchmark-gha]: https://github.com/tihiyn/eo/actions/runs/18214011085
