...
```text
to-java.xsl              85724  39.22%
classes.xsl              73405  33.59%
set-locators.xsl         16644  7.62%
set-original-names.xsl   10373  4.75%
attrs.xsl                8289   3.79%
data.xsl                 7599   3.48%
tests.xsl                5581   2.55%
anonymous-to-nested.xsl  5533   2.53%
package.xsl              5403   2.47%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-09-13 at 11:37,
on Linux with 4 CPUs.
The total is 218551 milliseconds.
...
[benchmark-gha]: https://github.com/tihiyn/eo/actions/runs/17695901587
