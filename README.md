...
```text
to-java.xsl              78047  37.27%
classes.xsl              62469  29.83%
set-locators.xsl         19063  9.10%
set-original-names.xsl   12536  5.99%
attrs.xsl                9850   4.70%
data.xsl                 9087   4.34%
anonymous-to-nested.xsl  6229   2.97%
tests.xsl                6135   2.93%
package.xsl              5968   2.85%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-11-13 at 10:54,
on Linux with 4 CPUs.
The total is 209384 milliseconds.
...
[benchmark-gha]: https://github.com/tihiyn/eo/actions/runs/19328831080
