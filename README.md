...
```text
to-java.xsl              87350  38.12%
classes.xsl              77291  33.73%
set-locators.xsl         17899  7.81%
set-original-names.xsl   11790  5.15%
attrs.xsl                9109   3.98%
data.xsl                 8190   3.57%
anonymous-to-nested.xsl  6048   2.64%
tests.xsl                5897   2.57%
package.xsl              5561   2.43%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-09-22 at 18:32,
on Linux with 4 CPUs.
The total is 229135 milliseconds.
...
[benchmark-gha]: https://github.com/tihiyn/eo/actions/runs/17924690245
